...
class _BookingStatusFilterBottomSheetState
  ...
  Future<List<BookingStatusResponses>>? future;

  List<BookingStatusResponses> list = [];
  ...
  Widget itemWidget(BookingStatusResponses res) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            24.height,
            FutureBuilder<List<BookingStatusResponses>>(
