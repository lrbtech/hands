...
import '../provider/utils/colors.dart';
import 'applied_tax_list_bottom_sheet.dart';

// final coommission = Commission.fromJson(jsonDecode(getStringAsync(DASHBOARD_COMMISSION)));
          ...
          Container(
            ...
            child: Column(
              children: [
                          ...
                          if (bookingDetail.isHourlyService)
                            Row(
                              ...
                              children: [
                                ...
                                PriceWidget(
                                    price: bookingDetail.amount!.toDouble(),
                ...
                //           Text(" (${couponData!.code})", style: boldTextStyle(size: 14, color: appStore.isDarkMode ? greenColor : context.primaryColor)).expand(),
                      ...
                      Row(
                        ...
                        children: [
                          Text(languages.lblSubTotal,
                              ...
                              .flexible(fit: FlexFit.loose),
                          PriceWidget(
                              price: bookingDetail.finalSubTotal.validate(),
                              color: textPrimaryColorGlobal,
                              isBoldText: true),
                        ],
                      ),
                ...
                //               children: [
                //                 Text('(', style: secondaryTextStyle()),
                //                 PriceWidget(price: ((bookingDetail.amount!.toDouble() * (2.9 / 100)) + 1), color: appTextSecondaryColor, size: 14, isBoldText: false),
                ...
                //           Row(
                //             children: [
                //               if (appStore.selectedLanguageCode == 'en') Text('- ', style: boldTextStyle()),
                //               PriceWidget(price: ((bookingDetail.amount!.toDouble() * (2.9 / 100)) + 1), normalColor: appStore.isDarkMode ? white : context.primaryColor),
                //               if (appStore.selectedLanguageCode == 'ar') Text(' -', style: boldTextStyle()),
                //             ],
                //           )
                //         ],
                //       ),
                ...
                Row(
                  ...
                  children: [
                    TextIcon(
                      text:
                          ' ${appStore.selectedLanguageCode == 'en' ? 'Hands commission' : 'عمولة هاندز'}',
                      textStyle: secondaryTextStyle(size: 14),
                      edgeInsets: EdgeInsets.zero,
                      expandedText: true,
                      maxLine: 2,
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (isCommissionTypePercent(
                                  bookingDetail.commission?.type))
                                Text(
                                  '${(bookingDetail.finalSubTotal.validate() * (bookingDetail.commission!.commission! / 100)).toStringAsFixed(2)}',
                                  style: boldTextStyle(
                                      size: 16,
                              ...
                              if (isCommissionTypePercent(
                                ...
                                8.width,
                              Text(
                                isCommissionTypePercent(
                                        bookingDetail.commission?.type)
                                    ? '${bookingDetail.commission?.commission.validate()}%'
                                    : '${isCurrencyPositionLeft ? appStore.currencySymbol : ""}${bookingDetail.commission?.commission.validate()}${isCurrencyPositionRight ? appStore.currencySymbol : ""}',
                                style: isCommissionTypePercent(
                                        bookingDetail.commission?.type)
                                    ? primaryTextStyle(
                                        color: appStore.isDarkMode
                                            ? white
                          ...
                          // if (bookingDetail.tip.validate() != 0) PriceWidget(price: (bookingDetail.finalTotalServicePrice.validate() + bookingDetail.tip.validate()), color: primaryColor),
                        ],
                      ),
                    ).flexible(flex: 3),
                  ],
                ...
                if (bookingDetail.tip.validate() != 0)
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      TextIcon(
                            ...
                            if (bookingDetail.isHourlyService)
                              Row(
                                ...
                                children: [
                                  Text('(', style: secondaryTextStyle()),
                                  PriceWidget(
                                      price: bookingDetail.tip.validate(),
                                      color: appTextSecondaryColor,
                                      size: 14,
                                      isBoldText: false),
                                  Text('/${languages.lblHr})',
                      ...
                      Row(
                        ...
                        children: [
                          TextIcon(
                            ...
                            textStyle: secondaryTextStyle(size: 14),
                            edgeInsets: EdgeInsets.zero,
                            suffix: Icon(Icons.info_outline_rounded,
                                size: 20, color: context.primaryColor),
                            expandedText: true,
                            maxLine: 3,
                            onTap: () {
