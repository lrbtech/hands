      ...
      children: [
        ...
        SnapHelperWidget(
          ...
          onSuccess: (balance) => Text(
            '${isCurrencyPositionLeft ? appStore.currencySymbol : ''}${balance.toStringAsFixed(getIntAsync(PRICE_DECIMAL_POINTS))}${isCurrencyPositionRight ? appStore.currencySymbol : ''}',
