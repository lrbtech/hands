...
class Configuration {
  ...
  Configuration({this.id, this.key, this.type, this.value, this.postJobRequest, this.valueAr});
...
class GeneralSettingModel {
  ...
  factory GeneralSettingModel.fromJson(Map<String, dynamic> json) {
    return GeneralSettingModel(
      ...
      siteDescriptionAR: json['site_description_ar'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['site_description_ar'] = this.siteDescriptionAR;
    if (this.languageOption != null) {
