...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      ...
      providersServiceRating: json['provider_rate'],
      // providersServiceRating: json['providers_service_rating'],
      totalServiceRating: json['provider_rating_count'],
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.providersServiceRating != null) data['provider_rate'] = this.providersServiceRating;
    // if (this.providersServiceRating != null) data['providers_service_rating'] = this.providersServiceRating;
    if (this.totalServiceRating != null) data['provider_rating_count'] = this.totalServiceRating;
    // if (this.totalServiceRating != null) data['total_service_rating'] = this.totalServiceRating;
