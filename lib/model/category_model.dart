...
class CategoryData {
  ...
  CategoryData({this.categoryImage, this.color, this.description, this.id, this.isFeatured, this.name, this.nameAr, this.status, this.isSelected = false, this.services});
