...
Future<Position> getUserLocationPosition() async {
  ...
  if (permission == LocationPermission.deniedForever) {
    throw 'Permission Denied Permanently';
  }
...
Future<String> buildStreetNameFromLatLong(
    double latitude, double longitude) async {
  List<Placemark> placeMark =
      await placemarkFromCoordinates(latitude, longitude).catchError((e) async {
    log(e);
  ...
  if (!place.street.isEmptyOrNull) street = '${place.street.validate()}';
