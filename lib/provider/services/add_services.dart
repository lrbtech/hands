...
import 'package:hands_user_app/models/visit_type_model.dart';
import 'package:hands_user_app/provider/networks/rest_apis.dart';
import 'package:hands_user_app/provider/services/components/category_sub_cat_drop_down.dart';
import 'package:hands_user_app/provider/services/components/service_address_component.dart';
import 'package:hands_user_app/provider/timeSlots/my_time_slots_screen.dart';
...
class _AddServicesState extends State<AddServices> {
  ...
  List<VisitTypeData> visitTypeData = [
    ...
    if (getBoolAsync(REMOTE_SERVICE_ENABLE))
      VisitTypeData(
          isEnabled: false,
