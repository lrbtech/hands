...
import 'package:hands_user_app/components/custom_image_picker.dart';
...
import 'package:hands_user_app/provider/packages/select_service_screen.dart';
...
class _AddPackageScreenState extends State<AddPackageScreen> {
  ...
  void selectDateAndTime(BuildContext context,
    ...
    await showDatePicker(
      ...
      locale: Locale(appStorePro.selectedLanguageCode),
      builder: (_, child) {
        return Theme(
          data: (appStorePro.isDarkMode
              ? ThemeData.dark()
              : AppTheme.lightTheme()),
          child: child!,
        );
            ...
            child: Column(
              children: [
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (appStorePro.selectedServiceList.isNotEmpty)
                  ...
                  children: [
                    AppTextField(
                      ...
                      decoration: inputDecoration(
                        ...
                        fillColor: context.scaffoldBackgroundColor,
                        prefix: Text(appStorePro.currencySymbol,
                ...
                Container(
                  ...
                  child: Theme(
                      data: ThemeData(
                        unselectedWidgetColor: appStorePro.isDarkMode
                      ...
                      child: CheckboxListTile(
                        ...
                        checkColor: appStorePro.isDarkMode
                            ? context.iconColor
                            : context.cardColor,
                        value: isFeature,
  ...
  Future checkValidation() async {
    if (formKey.currentState!.validate()) {
      ...
      if (appStorePro.selectedServiceList.isNotEmpty) {
        appStorePro.selectedServiceList.forEach((element) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Observer(
              builder: (_) =>
                  LoaderWidget().center().visible(appStorePro.isLoading)),
        ],
      ),
    );
  }
