...
import 'package:hands_user_app/provider/packages/components/selected_service_component.dart';
...
class _SelectServiceScreenState extends State<SelectServiceScreen> {
  ...
  void init() async {
    if (widget.isUpdate) {
      ...
      isPackageTypeSingle = appStorePro.isCategoryWisePackageService;
    }
  ...
  Future<void> fetchAllServices(
    ...
    await getServicesList(page,
      ...
      if (appStorePro.selectedServiceList.validate().isNotEmpty) {
        //appStorePro.selectedServiceList.any((e1) => serviceList.any((e2) => e2.id == e1.id));
        ...
        children: [
          AnimatedScrollView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                          '${languages.categoryBasedPackage} ${appStorePro.isCategoryWisePackageService ? languages.enabled : languages.disabled}',
                    ...
                    child: Switch.adaptive(
                      ...
                      onChanged: (v) {
                        showConfirmDialogCustom(
                          ...
                          title:
                              '${languages.doYouWantTo} ${!appStorePro.isCategoryWisePackageService ? languages.enable : languages.disable} ${languages.categoryBasedPackage}?',
                          positiveText: context.translate.lblYes,
                          negativeText: context.translate.lblNo,
                          onAccept: (p0) {
                            if (appStorePro.isCategoryWisePackageService) {
                              appStorePro.selectedServiceList.clear();
                              appStorePro.setLoading(true);
                              searchCont.text = '';
                            ...
                            appStorePro.setCategoryBasedPackageService(
              ...
              Column(
                ...
                children: [
                  ...
                  Text(languages.includedInThisPackage,
                      ...
                      .paddingSymmetric(horizontal: 16),
                  16.height,
                  if (!appStorePro.isLoading &&
                      appStorePro.selectedServiceList.isNotEmpty)
              ...
              //
              if (appStorePro.selectedServiceList.isEmpty) 16.height,
                      ...
                      child: Row(
                        ...
                        () {
                          if (data.isSelected.validate()) {
                            appStorePro.removeSelectedPackageService(data);
                          } else {
                            appStorePro.addSelectedPackageService(data);
                          }
                ...
                Observer(
                  builder: (context) {
                    return NoDataWidget(
                      ...
                      subTitle: "",
                    ).visible((!appStorePro.isLoading && serviceList.isEmpty));
                  },
                ),
              16.height,
              Observer(builder: (context) {
                return NoDataWidget(
                  ...
                  imageSize: Size(150, 150),
                  subTitle: "",
                ).center().visible(!appStorePro.isLoading &&
                    categoryId == -1 &&
                    isPackageTypeSingle.validate());
              }),
            ],
