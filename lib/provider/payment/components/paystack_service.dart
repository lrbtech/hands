...
class PayStackService {
  ...
  init(
    ...
    paystackPlugin.initialize(
        publicKey: currentPaymentMethod.isTest == 1 ? currentPaymentMethod.testValue!.paystackPublicKey.validate() : currentPaymentMethod.liveValue!.paystackPublicKey.validate());
    ctx = context;
