...
import '../../../../provider/networks/network_utils.dart';
import '../../../../provider/utils/common.dart';
import '../../../../provider/utils/configs.dart';
import '../../../../provider/utils/images.dart' hide delete;
                  ...
                  : isSuccess
                      ? Column(
                          children: [
                            ...
                            10.height,
                            Text(languages.paymentSuccess,
                                style: boldTextStyle()),
                            16.height,
                            Text(languages.redirectingToBookings,
                                textAlign: TextAlign.center,
                                style: secondaryTextStyle()),
                          ],
                        ).paddingAll(16)
                      : isTxnInProgress
                          ? Column(
                              children: [
                                LoaderWidget(),
                                10.height,
                                Text(languages.transactionIsInProcess,
                                    style: boldTextStyle()),
                                16.height,
                                Text(languages.pleaseCheckThePayment,
                                    textAlign: TextAlign.center,
                                    style: secondaryTextStyle()),
                              ],
                            ).paddingAll(16)
                                ...
                                Form(
                                  ...
                                  child: AppTextField(
                                    ...
                                    decoration: inputDecoration(context,
                                        hint: languages.enterYourMsisdnHere),
                                  ),
                                ),
                                16.height,
                                AppButton(
...
(String, String) getAirtelMoneyReasonTextFromCode(String code) {
  switch (code) {
    ...
    case AirtelMoneyResponseCodes.LIMIT_EXCEEDED:
      return (
        languages.exceedsWithdrawalAmountLimitS,
        languages.theUserHasExceeded
      );
    ...
    case AirtelMoneyResponseCodes.TRANSACTION_NOT_PERMITTED:
      return (
        languages.transactionNotPermittedTo,
        languages.payeeIsAlreadyInitiated
      );
    ...
    case AirtelMoneyResponseCodes.FETCHED_ENCRYPTION_KEY_SUCCESSFULLY:
      return (
        languages.successfullyFetchedEncryptionKey,
        languages.encryptionKeyHasBeen
      );
    case AirtelMoneyResponseCodes.ERROR_FETCHING_ENCRYPTION_KEY:
      return (
        languages.errorWhileFetchingEncryption,
        languages.couldNotFetchEncryption
      );
    case AirtelMoneyResponseCodes.TRANSACTION_EXPIRED:
      return (
        languages.transactionExpired,
        languages.transactionHasBeenExpired
      );
    default:
