...
import 'package:hands_user_app/provider/screens/cash_management/model/cash_detail_model.dart';
  ...
  await showConfirmDialogCustom(
    ...
    onAccept: (p0) async {
      Map<String, dynamic> req = {
        ...
        "datetime":
            formatBookingDate(DateTime.now().toString(), format: DATE_FORMAT_7),
