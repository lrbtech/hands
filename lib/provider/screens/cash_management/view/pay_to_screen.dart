...
import 'package:hands_user_app/models/user_bank_model.dart';
...
import 'package:hands_user_app/provider/screens/cash_management/cash_constant.dart';
import 'package:hands_user_app/provider/screens/cash_management/cash_repository.dart';
import 'package:hands_user_app/provider/screens/cash_management/model/cash_filter_model.dart';
import 'package:hands_user_app/provider/screens/cash_management/model/payment_history_model.dart';
...
class _PayToScreenState extends State<PayToScreen> {
  ...
  void loadBankDetails() {
    future = getUserBankDetail(userId: appStorePro.providerId.validate());
  }
              ...
              Positioned(
                ...
                child: AppButton(
                  onTap: () {
                    ...
                    widget.paymentData.senderId = appStorePro.userId;
                    widget.paymentData.receiverId = appStorePro.providerId;
