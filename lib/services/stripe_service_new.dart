...
class StripeServiceNew {
  ...
  Future<dynamic> stripePay() async {
    ...
    Stripe.merchantIdentifier = 'merchant.com.handsappuae.user';
    ...
    await request.send().then((value) {
      http.Response.fromStream(value).then((response) async {
        if (response.statusCode.isSuccessful()) {
          ...
          print('STTTTTRRRRRIIIIIIIPPPPPE');
          ...
          print(res.captureMethod);
          print(res.paymentMethod);
          print(res.paymentMethodOptions?.card?.network);
          print(res.paymentMethodTypes);
          print(res.confirmationMethod);
          ...
          await Stripe.instance.initPaymentSheet(paymentSheetParameters: setupPaymentSheetParameters).then((value) async {
            ...
            appStore.setLoading(false);
            print('_________________________ERROR__________________________');
            print(exc.toString());
