                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${isCurrencyPositionLeft ? appStore.currencySymbol : ''}${snap[index].activityData!.creditDebitAmount.validate().toStringAsFixed(getIntAsync(PRICE_DECIMAL_POINTS))}${isCurrencyPositionRight ? appStore.currencySymbol : ''}',
