...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> init() async {
    ...
    if (appStore.userContactNumber.validate().startsWith('971-')) {
      mobileCont.text = '${appStore.userContactNumber.validate().replaceFirst('971-', '')}';
    } else if (appStore.userContactNumber.validate().length == 9) {
  ...
  Future<void> userDetailAPI() async {
    await getUserDetail(appStore.userId!).then((value) {
      isEmailVerified = value.emailVerified.getBoolInt();
      setState(() {});
    }).catchError((e) {
  ...
  Future<void> update() async {
    ...
    multiPartRequest.fields[UserKeys.contactNumber] = '971-${mobileCont.text.trim()}';
  ...
  Future<void> verifyEmail() async {
    ...
    await verifyUserEmail(emailCont.text).then((value) {
                  ...
                  children: [
                    Container(
                      ...
                      child: imageFile != null
                          ...
                          : // [null, ''].contains(appStore.userProfileImage)
                          //     ? ClipOval(
                          //         child: Image.asset(
