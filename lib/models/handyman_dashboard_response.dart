...
import 'package:hands_user_app/models/configuration_response.dart';
...
class HandymanDashBoardResponse {
  ...
  List<RatingDatas>? handymanReviews;
  bool? status;
  num? todayBooking;
  num? totalBooking;
  num? totalRevenue;
  num? todayCashAmount;
  List<BookingDatas>? upcomingBookings;
  ...
  HandymanDashBoardResponse.fromJson(Map<String, dynamic> json) {
    ...
    countryList = json["country"] == null
        ? []
        : List<CountryElement>.from(
            json["country"]!.map((x) => CountryElement.fromJson(x)));
    helplineNumber = json['helpline_number'];
    isEmailVerified = json['is_email_verified'];
    isAdvancePaymentAllowed = json['is_advanced_payment_allowed'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_advanced_payment_allowed'] = this.isAdvancePaymentAllowed;
    ...
    if (this.handymanReviews != null) {
      data['handyman_reviews'] =
          this.handymanReviews!.map((v) => v.toJson()).toList();
    }
    ...
    if (this.countryList != null) {
      data['country'] =
          this.countryList.validate().map((e) => e.toJson()).toList();
    }
...
class Configurations {
  ...
  Configurations({this.countryList, this.id, this.key, this.type, this.value});
