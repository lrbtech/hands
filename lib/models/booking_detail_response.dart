...
class BookingDetailResponses {
  ...
  BookingDetailResponses.fromJson(Map<String, dynamic> json) {
    bookingDetail = json['booking_detail'] != null
        ? new BookingDatas.fromJson(json['booking_detail'])
        : null;
    ...
    if (json['rating_data'] != null) {
      ...
      json['rating_data'].forEach((v) {
        RatingData!.add(new RatingDatas.fromJson(v));
      });
    }
...
class RatingDatas {
  ...
  RatingDatas.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    rating = json['rating'];
    review = json['review'];
