...
class HandymanInfoResponse {
  ...
  HandymanInfoResponse(
      {this.handymanData, this.service, this.handymanRatingReview});
  ...
  HandymanInfoResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['handyman_rating_review'] != null) {
      json['handyman_rating_review'].forEach((v) {
        handymanRatingReview!.add(new RatingDatas.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.handymanRatingReview != null) {
      data['handyman_rating_review'] =
          this.handymanRatingReview!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
