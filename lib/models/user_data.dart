...
class UserData {
  ...
  UserData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['category_ids'] != null) {
      json['category_ids'].forEach((id) {
        categoriesIds?.add(id.toString());
      });
    }
    ...
    slotsForAllServices = json['slots_for_all_services'] != null
        ? json['slots_for_all_services']
        : 0;
    email = json['email'];
    gender = json['gender'];
    ...
    totalServiceRating = json['total_service_rating'];
    ...
    isHandymanAvailable = json['isHandymanAvailable'] != null
        ? json['isHandymanAvailable'] == 1
        : false;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.categoriesIds != null) data['category_ids'] = this.categoriesIds;
    if (this.slotsForAllServices != null)
    ...
    if (this.totalServiceRating != null)
      data['total_service_rating'] = this.totalServiceRating;
    if (this.providerServiceRating != null)
      data['providers_service_rating'] = this.providerServiceRating;
    ...
    if (this.isHandymanAvailable != null)
...
class WhyChooseMe {
  ...
  factory WhyChooseMe.fromJson(Map<String, dynamic> json) {
    return WhyChooseMe(
      title: json['why_choose_me_title'] is String
          ? json['why_choose_me_title']
          : "",
